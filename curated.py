...
def filter_python_examples(dataset):
    ...
    for item in dataset:
        ...
        input_text = item.get('input', '').lower()  # Ensure to include 'input' in the filtering
        if 'python' in instruction or 'python' in output or 'python' in input_text:
...
if __name__ == "__main__":
    input_file_path = 'C:/Users/benha/Documents/GitHub/text-generation-webui/training/datasets/formatted_dataset.json'
    output_file_path = 'C:/Users/benha/Documents/GitHub/text-generation-webui/training/datasets/curated_python_examples.json'
